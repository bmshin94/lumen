...
## [0.1.4](https://github.com/lucid-softworks/lumen/compare/v0.1.3...v0.1.4) - 2026-09-08
...
## [0.1.3](https://github.com/lucid-softworks/lumen/compare/v0.1.2...v0.1.3) - 2026-07-27
...
- *(tests)* scope scheduler planner checks to arm64
- *(lumen)* update x64 new opcode match
...
- speed up JIT constructor dispatch
- *(lumen)* expand guarded JIT regions and packed fast paths
